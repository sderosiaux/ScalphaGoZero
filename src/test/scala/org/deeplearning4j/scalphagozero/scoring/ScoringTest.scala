...
class ScoringTest extends FunSpec {
  ...
  describe("Creating an artificial 5x5 game for scoring, the territory") {
    ...
    board.placeStone(PlayerBlack, Point(1, 4))
    board.placeStone(PlayerBlack, Point(2, 2))
    board.placeStone(PlayerBlack, Point(2, 3))
    board.placeStone(PlayerBlack, Point(2, 4))
    board.placeStone(PlayerBlack, Point(2, 5))
    board.placeStone(PlayerBlack, Point(3, 1))
    board.placeStone(PlayerBlack, Point(3, 2))
    board.placeStone(PlayerBlack, Point(3, 3))

    board.placeStone(PlayerWhite, Point(3, 4))
    board.placeStone(PlayerWhite, Point(3, 5))
    board.placeStone(PlayerWhite, Point(4, 1))
    board.placeStone(PlayerWhite, Point(4, 2))
    board.placeStone(PlayerWhite, Point(4, 3))
    board.placeStone(PlayerWhite, Point(4, 4))
    board.placeStone(PlayerWhite, Point(5, 2))
    board.placeStone(PlayerWhite, Point(5, 4))
    board.placeStone(PlayerWhite, Point(5, 5))
